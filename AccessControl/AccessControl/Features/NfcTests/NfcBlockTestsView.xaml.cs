namespace AccessControl.Features
{
    ...
    public partial class NfcBlockTestsView
    {
        ...
        private void btnReadBlock_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            byte[] result = nfcService.ReadByteBlock(16, key, NfcKeyType.KeyB );
        ...
        {
            byte[] key = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
            byte[] content = new byte[] { 0x4A, 0x6F, 0x72, 0x67, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
            bool result = nfcService.WriteByteBlock(16, key, content, NfcKeyType.KeyB);
